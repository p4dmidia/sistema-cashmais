...
async function run() {
    ...
    await testUrl('Company Reg', '/api/empresa/registrar', 'POST'); 
    await testUrl('Affiliate Reg', '/api/affiliate/register', 'POST');
    await testUrl('Affiliate Reg (No Prefix)', '/affiliate/register', 'POST');
    await testUrl('Company Reg (No Prefix)', '/empresa/registrar', 'POST');
}
